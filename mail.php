...
sendMail(trim(@$_POST['name']),trim(@$_POST['email']),'Emaar Properties','Emaar Palm Heights',trim(@$_POST['country']),trim(@$_POST['comment']),$_POST["phone"],$time);
$country_n=country_fetch(trim($_POST['country']));
sendToRemoteServer("www.emaarpalmheightsgurgaon.org.in",'Emaar Palm Heights',trim(@$_POST['name']),$_POST["phone"],trim(@$_POST['email']),trim(@$country_n),trim(@$_POST['comment']));
